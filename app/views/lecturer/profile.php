...
<body>
  <div class="container mt-5 profile">
    <form action="<?= BASEURL ?>/Profile/UpdateLecturer" enctype="multipart/form-data" method="POST">
      <div class="row d-flex justify-content-center">
        <div class="d-flex flex-row mt-4 ms-5">
          ...
          <a href="<?= BASEURL ?>/Profile/Lecturer?update=1" class="ms-auto me-5 btn btn-save">Update Profile</a>
          <?php elseif (isset($_GET['update'])) : ?>
          <a href="<?= BASEURL ?>/Profile/Lecturer" class="ms-auto me-5 btn btn-save">Cancel</a>
          <?php endif; ?>
        </div>
