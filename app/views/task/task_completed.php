  ...
  <nav class="mb-5">
    <ul class="pagination justify-content-end">
      ...
      if ($page == 1) {
        ...
        echo '<li class="page-item halaman_completed" id="1"><a class="page-link" href="#">First</a></li>';
        echo '<li class="page-item halaman_completed" id="' . $link_prev . '"><a class="page-link" href="#"><span aria-hidden="true">&laquo;</span></a></li>';
      }

      for ($i = $start_number; $i <= $end_number; $i++) {
        $link_active = ($page == $i) ? ' active' : '';
        echo '<li class="page-item halaman_completed ' . $link_active . '" id="' . $i . '"><a class="page-link" href="#">' . $i . '</a></li>';
      }
      ...
      if ($page == $total_page) {
        ...
        echo '<li class="page-item halaman_completed" id="' . $link_next . '"><a class="page-link" href="#"><span aria-hidden="true">&raquo;</span></a></li>';
        echo '<li class="page-item halaman_completed" id="' . $total_page . '"><a class="page-link" href="#">Last</a></li>';
      }
      ?>
    </ul>
  </nav>
